      ...
      <section className="bg-secondary py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            About Victory Shoes Collection
          </h1>
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <div className="animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Victory Shoe Collection was founded with a simple mission: to
              create premium footwear that doesn't compromise on style, comfort,
              or performance. We believe that the right pair of shoes can
          ...
          <div className="animate-fade-in animate-delay-200">
            <p className="text-lg text-muted-foreground leading-relaxed">
              Each pair of Victory shoes is crafted with meticulous attention to
              detail, using only the finest materials and latest technology.
              From the boardroom to the running track, from casual outings to
              special occasions, we've got your feet covered.
            </p>
          </div>
