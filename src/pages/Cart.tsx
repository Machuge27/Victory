    ...
    return (
      <main className="min-h-screen py-16 flex items-center justify-center">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-muted-foreground mb-8">Add some amazing shoes to get started!</p>
  ...
  return (
    <main className="min-h-screen py-16">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-12 animate-fade-in">Shopping Cart</h1>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t border-border pt-4">
                  <div className="flex justify-between text-xl font-bold">
                    <span>Total</span>
                    <span className="text-gold">KSh {totalPrice.toLocaleString()}</span>
                  </div>
                </div>
              </div>
